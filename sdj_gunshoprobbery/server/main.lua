					...
					if robbers[_source] then
						...
						if xPlayer then
							...
							if chance >= 1 and chance <= 5 then
								xPlayer.addWeapon('WEAPON_SMG', 300)
							elseif chance >= 6 and chance <= 10 then
								xPlayer.addWeapon('WEAPON_MINISMG', 300)
							elseif chance <= 25 and chance >= 11 then
								xPlayer.addWeapon('WEAPON_HEAVYPISTOL', 300)
							elseif chance <= 50 and chance >= 26 then
								xPlayer.addWeapon('WEAPON_MARKSMANPISTOL', 300)
							elseif chance <= 100 and chance >= 91 then
								xPlayer.addWeapon('WEAPON_APPISTOL', 300)
							elseif chance <= 90 and chance >= 51 then
								xPlayer.addWeapon('WEAPON_MACHINEPISTOL', 300)
							end
